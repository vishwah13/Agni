...
void vkutil::transitionImage(VkCommandBuffer cmd,
                             VkImage         image,
                             ...
                             VkImageLayout   newLayout)
{
	...
	// very infficient to use ALL_COMMANDS_BIT
...
void vkutil::copyImageToImage(VkCommandBuffer cmd,
                              VkImage         source,
                              VkImage         destination,
                              VkExtent2D      srcSize,
                              VkExtent2D      dstSize)
...
void vkutil::generateMipmaps(VkCommandBuffer cmd,
                             VkImage         image,
                             VkExtent2D      imageSize)
{
	int mipLevels =
	int(std::floor(std::log2(std::max(imageSize.width, imageSize.height)))) + 1;
